export default function DatenschutzPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 prose prose-invert text-sm text-[#cfcfdb] space-y-4">
      <h1 className="text-2xl font-bold text-[#f4f4f8]">Datenschutz & Hinweise</h1>
      <p>
      ...
      <h2 className="text-lg font-semibold text-[#f4f4f8]">Welche Daten werden gespeichert?</h2>
      ...
      <h2 className="text-lg font-semibold text-[#f4f4f8]">Was wir NICHT speichern</h2>
      <p>Zahlungsdaten (Kartennummer etc.) werden nicht gespeichert, geprüft oder übertragen.</p>
      <p className="text-[#6b6b7a] text-xs pt-4">
